// Mock category data. `icon` refers to a lucide-react icon name resolved in CategoryIcon.jsx
...
export function getCategory(id) {
  return mockCategories.find((c) => c.id === id) ?? mockCategories[mockCategories.length - 1]
}
