...
test('layout anual contém resumos, meses, categorias e somente uma área de lançamentos', () => {
  ...
  const transaction = { id: 9, date: '2024-02-29', competence_year: 2024, competence_month: 2, type: 'expense', description: 'Café', category_id: 3, category_name: 'Alimentação', amount: 12.34, status: 'confirmed', tags: '[]', source: 'manual', is_recurring: 0, is_fixed: 0, created_at: '2024-02-29 10:00:00' }
  ...
  assert.equal(layout.values[0][16], 3)
